...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="page-title">Tạo mới Phương thức thanh toán</h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => ['payments.store'], 'method' => 'post', 'role' => 'form', 'class' => 'form-horizontal', 'files' => true]) !!}
                        @include('layouts.partials.errors')

                        <div class="form-group">
                            <label class="col-md-3 control-label">Tên Phương thức thanh toán</label>
                            <div class="col-md-9">
                                {!! Form::text('name', null, ['id' => 'name', 'class' => 'form-control', 'placeholder' => 'Tên Phương thức thanh toán']) !!}
                            </div>
                        </div>
