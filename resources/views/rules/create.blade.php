...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="page-title">Tạo mới cơ chế</h4>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <div class="row">
                    <div class="col-sm-12">
                        {!! Form::open(['route' => ['rules.store'], 'method' => 'post', 'role' => 'form', 'class' => 'form-horizontal', 'files' => true]) !!}
                        @include('layouts.partials.errors')

                        <div class="form-group">
                            <label class="col-md-3 control-label">Tên cơ chế</label>
                            <div class="col-md-9">
                                {!! Form::text('name', null, ['id' => 'name', 'class' => 'form-control', 'placeholder' => 'Tên cơ chế']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('price', null, ['id' => 'price', 'class' => 'form-control money', 'placeholder' => 'Đơn giá']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('salary', null, ['id' => 'salary', 'class' => 'form-control money', 'placeholder' => 'Lương']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('award', null, ['id' => 'award', 'class' => 'form-control money', 'placeholder' => 'Thưởng']) !!}
                            </div>
                        </div>
